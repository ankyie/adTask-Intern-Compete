...
const Hero = () => {
  return (
    <div>
      <div className="sm:min-h-screen min-h-[75vh] w-full bg-white dark:bg-[#050506] dark:bg-grid-white/[0.02] bg-grid-[#050506]/[0.05] relative flex justify-center">
        ...
        <main className="pt-16">
          <div className="flex flex-col items-center md:gap-16 gap-8">
            <div>
              <NavbarTop
                navItems={[
                  { name: "Products", link: "#", icon: <GoTriangleDown /> },
            ...
            <div className="relative z-20 md:w-[767px] w-full">
              <div className="flex flex-col items-center p-2 justify-center md:gap-16 gap-4">
                <ShimmerButton />
                <div className="cursor-default animate-spotlight">
                  ...
                  `}</style>
                  <h1 className="md:text-8xl text-5xl bg-gradient-to-t from-gray-500 to-white inline-block text-transparent bg-clip-text glow-on-hover duration-500">
                    ad<span className="font-semibold">Task</span>.ai
                  </h1>
                </div>
                <div className="hero-quote text-center xl:text-base sm:text-sm text-xs font-light">
                  <p>
              ...
              <div className="flex flex-col justify-center items-center md:mt-10 mt-4 gap-3">
                <Button
                  borderClassName={
      ...
      <div className="relative md:-top-28 -top-6">
        <VideoIntro />
      </div>
    </div>
  );
