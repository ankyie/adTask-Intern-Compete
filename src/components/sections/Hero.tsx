            ...
            <div className="relative z-20 md:w-[767px] w-full">
              <div className="flex flex-col items-center justify-center gap-16">
                ...
                <div className="cursor-default animate-spotlight">
                  ...
                  `}</style>
                  <h1 className="md:text-8xl text-7xl bg-gradient-to-t from-gray-500 to-white inline-block text-transparent bg-clip-text glow-on-hover duration-500">
                    ad<span className="font-semibold">Task</span>.ai
                  </h1>
                </div>
                <div className="hero-quote text-center xl:text-base text-sm font-light">
                  <p>
