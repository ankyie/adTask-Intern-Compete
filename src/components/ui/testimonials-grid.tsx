...
const TestimonialGrid = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-2">
      { testimonials.map((item, index) => {return <div key={index} className="testimonial-card bg-gradient-to-l from-[#7687B5] to-[#333B4F]/80 p-[1px] md:w-[352px] md:h-[196px] w-[282px] rounded-xl">
